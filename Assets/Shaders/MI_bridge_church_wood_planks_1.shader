Shader "Unreal/MI_bridge_church_wood_planks_1"
{
    Properties
    {
		...
		Grunge_tiling_R_channel( "Grunge_tiling_R_channel", Float ) = 50.000000
		Grunge_channel_R_power( "Grunge_channel_R_power", Float ) = 300.000000
		...
		Grunge_tiling_G_channel( "Grunge_tiling_G_channel", Float ) = 10.000000
		Grunge_channel_G_power( "Grunge_channel_G_power", Float ) = 100.000000
		...
		B_channel_blend( "B_channel_blend", Float ) = 1.000000
		B_channel_extend( "B_channel_extend", Float ) = 0.000000
		UVmask_B_opacity_bloor( "UVmask_B_opacity_bloor", Float ) = 1.000000
		UVmask_B_opacity( "UVmask_B_opacity", Float ) = 1.000000
		Grunge_tiling_B_channel( "Grunge_tiling_B_channel", Float ) = 50.000000
		Grunge_channel_B_power( "Grunge_channel_B_power", Float ) = 33.193413
		...
		Brightness_main_layer( "Brightness_main_layer", Float ) = 1.000000
		...
		Brightness_R_channel( "Brightness_R_channel", Float ) = 0.822334
		contrast_R_channel( "contrast_R_channel", Float ) = -1.706784
		Tint_base_color_R_channel( "Tint_base_color_R_channel", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		color_tone_G_channel( "color_tone_G_channel", Float ) = 1.034735
		Brightness_G_channel( "Brightness_G_channel", Float ) = 0.317333
		contrast_G_channel( "contrast_G_channel", Float ) = -0.948610
		...
		Brightness_B_channel( "Brightness_B_channel", Float ) = 0.468000
    ...
    SubShader
    {
        ...
        #include "MI_bridge_church_wood_planks_1.hlsl"

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(15.000000,15.000000,5.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[10] = float4(15.000000,15.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[15] = float4(0.000000,0.000000,15.000000,15.000000);//(Unknown)
	...
	Material.PreshaderBuffer[22] = float4(0.700000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(0.560000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(1.000000,1.000000,1.000000,-5.889883);//(Unknown)
	Material.PreshaderBuffer[26] = float4(0.452927,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(1.000000,1.000000,1.000000,0.276460);//(Unknown)

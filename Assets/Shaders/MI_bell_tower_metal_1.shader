Shader "Unreal/MI_bell_tower_metal_1"
{
    Properties
    {
		...
		Material_Texture2D_18( "main_layer_Metallic", 2D ) = "white" {}
		...
		UV_Tiling_main_layer( "UV_Tiling_main_layer", Float ) = 6.000000
		...
		UV_Tiling_R_channel( "UV_Tiling_R_channel", Float ) = 6.000000
		...
		UV_Tiling_G_channel( "UV_Tiling_G_channel", Float ) = 6.000000
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 6.000000
    ...
    SubShader
    {
        ...
        #include "MI_bell_tower_metal_1.hlsl"

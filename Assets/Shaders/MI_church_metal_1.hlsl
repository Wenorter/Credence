...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(10.000000,10.000000,5.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,1.000000,-0.472000,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1.000000,1.000000,2.000000,-1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[11] = float4(0.000000,1.000000,10.000000,0.300000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,100.000000,10.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(-1.000000,2.601330,-1.601330,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[17] = float4(8.829271,0.472540,1.000000,10.000000);//(Unknown)
	Material.PreshaderBuffer[18] = float4(1.000000,2.000000,-1.000000,3.000000);//(Unknown)
	Material.PreshaderBuffer[19] = float4(-2.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[20] = float4(2.000000,-1.000000,1.000000,-0.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.000000,1.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[22] = float4(10.000000,10.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[23] = float4(0.000000,1.000000,1.000000,0.300000);//(Unknown)
	Material.PreshaderBuffer[24] = float4(1.000000,1.000000,4.000000,3.000000);//(Unknown)
	...
	Material.PreshaderBuffer[27] = float4(0.400000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(0.200000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(1.000000,1.000000,1.000000,-6.170107);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.828927,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[33] = float4(1.000000,1.000000,1.000000,0.502655);//(Unknown)
	Material.PreshaderBuffer[34] = float4(0.632000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[35] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[36] = float4(0.700000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[41] = float4(0.000000,0.150000,0.150000,0.150000);//(Unknown)
	Material.PreshaderBuffer[42] = float4(0.150000,0.150000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[43] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[44] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[45] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[46] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[47] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[25].z = SelectionColor.w;
	Material.PreshaderBuffer[26].xyz = SelectionColor.xyz;
	Material.PreshaderBuffer[26].w = color_tone_main_layer * 6.283;
	Material.PreshaderBuffer[27].x = Brightness_main_layer;
	Material.PreshaderBuffer[27].y = contrast_main_layer;
	Material.PreshaderBuffer[28].xyz = Tint_base_color_main_layer.xyz;
	Material.PreshaderBuffer[28].w = color_tone_R_channel * 6.283;
	Material.PreshaderBuffer[29].x = Brightness_R_channel;
	Material.PreshaderBuffer[29].y = contrast_R_channel;
	Material.PreshaderBuffer[30].xyz = Tint_base_color_R_channel.xyz;
	Material.PreshaderBuffer[30].w = color_tone_G_channel * 6.283;
	Material.PreshaderBuffer[32].x = Brightness_G_channel;
	Material.PreshaderBuffer[32].y = contrast_G_channel;
	Material.PreshaderBuffer[33].xyz = Tint_base_color_G_channel.xyz;
	Material.PreshaderBuffer[33].w = color_tone_B_channel * 6.283;
	Material.PreshaderBuffer[34].x = Brightness_B_channel;
	Material.PreshaderBuffer[34].y = contrast_B_channel;
	Material.PreshaderBuffer[35].xyz = Tint_base_color_B_channel.xyz;
	Material.PreshaderBuffer[35].w = color_tone_B_all_mask * 6.283;
	Material.PreshaderBuffer[36].x = Brightness_B_all_mask;
	Material.PreshaderBuffer[36].y = contrast_B_all_mask;
	Material.PreshaderBuffer[37].xyz = Tint_base_color_B_all_mask.xyz;
	Material.PreshaderBuffer[37].w = color_tone_TopTint_layer * 6.283;
	Material.PreshaderBuffer[38].x = Brightness_TopTint_layer;
	Material.PreshaderBuffer[38].y = contrast_TopTint_layer;
	Material.PreshaderBuffer[39].xyz = Tint_base_color_TopTint_layer.xyz;
	Material.PreshaderBuffer[39].w = Metallic_Contrast_main_layer;
	Material.PreshaderBuffer[40].x = 1 - Metallic_Intensity_main_layer;
	Material.PreshaderBuffer[40].y = Metallic_R_channel;
	Material.PreshaderBuffer[40].z = Metallic_G_channel;
	Material.PreshaderBuffer[40].w = Metallic_B_channel;
	Material.PreshaderBuffer[41].x = Metallic_TopTint_layer;
	Material.PreshaderBuffer[41].y = Specular_main_layer;
	Material.PreshaderBuffer[41].z = Specular_R_channel;
	Material.PreshaderBuffer[41].w = Specular_G_channel;
	Material.PreshaderBuffer[42].x = Specular_B_channel;
	Material.PreshaderBuffer[42].y = Specular_TopTint_layer;
	Material.PreshaderBuffer[42].z = Roughness_max_main_layer;
	Material.PreshaderBuffer[42].w = Roughness_min_main_layer;
	Material.PreshaderBuffer[43].x = Roughness_max_R_channel;
	Material.PreshaderBuffer[43].y = Roughness_min_R_channel;
	Material.PreshaderBuffer[43].z = Roughness_max_G_channel;
	Material.PreshaderBuffer[43].w = Roughness_min_G_channel;
	Material.PreshaderBuffer[44].x = Roughness_max_B_channel;
	Material.PreshaderBuffer[44].y = Roughness_min_B_channel;
	Material.PreshaderBuffer[44].z = Roughness_max_B_all_mask;
	Material.PreshaderBuffer[44].w = Roughness_min_B_all_mask;
	Material.PreshaderBuffer[45].x = Roughness_max_TopTint_layer;
	Material.PreshaderBuffer[45].y = Roughness_min_TopTint_layer;
	Material.PreshaderBuffer[45].z = AO_Contrast_main_layer;
	Material.PreshaderBuffer[45].w = 1 - AO_Intensity_main_layer;
	Material.PreshaderBuffer[46].x = AO_Contrast_R_channel;
	Material.PreshaderBuffer[46].y = 1 - AO_Intensity_R_channel;
	Material.PreshaderBuffer[46].z = AO_Contrast_G_channel;
	Material.PreshaderBuffer[46].w = 1 - AO_Intensity_G_channel;
	Material.PreshaderBuffer[47].x = AO_Contrast_B_channel;
	Material.PreshaderBuffer[47].y = 1 - AO_Intensity_B_channel;
	Material.PreshaderBuffer[47].z = AO_Contrast_TopTint_layer;
	Material.PreshaderBuffer[47].w = 1 - AO_Intensity_TopTint_layer;
}
...
SHADER_DISABLE_WARNINGS
	...
	PixelMaterialInputs.Normal = Local198;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local199 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[26].xyz,Material.PreshaderBuffer[25].z);
	MaterialFloat Local200 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 6);
	MaterialFloat4 Local201 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_17,GetMaterialSharedSampler(samplerMaterial_Texture2D_17,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7)));
	MaterialFloat Local202 = MaterialStoreTexSample(Parameters, Local201, 6);
	MaterialFloat3 Local203 = (Local201.rgb * ((MaterialFloat3)Material.PreshaderBuffer[27].x));
	MaterialFloat Local204 = dot(Local203,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local205 = lerp(Local203,((MaterialFloat3)Local204),Material.PreshaderBuffer[27].y);
	MaterialFloat3 Local206 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[26].w),((MaterialFloat3)0.00000000),Local205);
	MaterialFloat3 Local207 = (Local206 + Local205);
	MaterialFloat3 Local208 = (Local207 * Material.PreshaderBuffer[28].xyz);
	MaterialFloat Local209 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local18), 6);
	MaterialFloat4 Local210 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_18,GetMaterialSharedSampler(samplerMaterial_Texture2D_18,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local18)));
	MaterialFloat Local211 = MaterialStoreTexSample(Parameters, Local210, 6);
	MaterialFloat3 Local212 = (Local210.rgb * ((MaterialFloat3)Material.PreshaderBuffer[29].x));
	MaterialFloat Local213 = dot(Local212,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local214 = lerp(Local212,((MaterialFloat3)Local213),Material.PreshaderBuffer[29].y);
	MaterialFloat3 Local215 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[28].w),((MaterialFloat3)0.00000000),Local214);
	MaterialFloat3 Local216 = (Local215 + Local214);
	MaterialFloat3 Local217 = (Local216 * Material.PreshaderBuffer[30].xyz);
	MaterialFloat3 Local218 = lerp(Local208,Local217,Local59.r);
	MaterialFloat Local219 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local66), 6);
	MaterialFloat4 Local220 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_19,GetMaterialSharedSampler(samplerMaterial_Texture2D_19,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local66)));
	MaterialFloat Local221 = MaterialStoreTexSample(Parameters, Local220, 6);
	MaterialFloat3 Local222 = (Local220.rgb * ((MaterialFloat3)Material.PreshaderBuffer[32].x));
	MaterialFloat Local223 = dot(Local222,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local224 = lerp(Local222,((MaterialFloat3)Local223),Material.PreshaderBuffer[32].y);
	MaterialFloat3 Local225 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[30].w),((MaterialFloat3)0.00000000),Local224);
	MaterialFloat3 Local226 = (Local225 + Local224);
	MaterialFloat3 Local227 = (Local226 * Material.PreshaderBuffer[33].xyz);
	MaterialFloat3 Local228 = lerp(Local218,Local227,Local99.r);
	MaterialFloat Local229 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local106), 6);
	MaterialFloat4 Local230 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_20,GetMaterialSharedSampler(samplerMaterial_Texture2D_20,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local106)));
	MaterialFloat Local231 = MaterialStoreTexSample(Parameters, Local230, 6);
	MaterialFloat3 Local232 = (Local230.rgb * ((MaterialFloat3)Material.PreshaderBuffer[34].x));
	MaterialFloat Local233 = dot(Local232,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local234 = lerp(Local232,((MaterialFloat3)Local233),Material.PreshaderBuffer[34].y);
	MaterialFloat3 Local235 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[33].w),((MaterialFloat3)0.00000000),Local234);
	MaterialFloat3 Local236 = (Local235 + Local234);
	MaterialFloat3 Local237 = (Local236 * Material.PreshaderBuffer[35].xyz);
	MaterialFloat3 Local238 = lerp(Local228,Local237,Local139.r);
	MaterialFloat3 Local239 = (Local238 * ((MaterialFloat3)Material.PreshaderBuffer[36].x));
	MaterialFloat Local240 = dot(Local239,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local241 = lerp(Local239,((MaterialFloat3)Local240),Material.PreshaderBuffer[36].y);
	MaterialFloat3 Local242 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[35].w),((MaterialFloat3)0.00000000),Local241);
	MaterialFloat3 Local243 = (Local242 + Local241);
	MaterialFloat3 Local244 = (Local243 * Material.PreshaderBuffer[37].xyz);
	MaterialFloat3 Local245 = lerp(Local238,Local244,Local154);
	MaterialFloat Local246 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local160), 6);
	MaterialFloat4 Local247 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_21,GetMaterialSharedSampler(samplerMaterial_Texture2D_21,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local160)));
	MaterialFloat Local248 = MaterialStoreTexSample(Parameters, Local247, 6);
	MaterialFloat3 Local249 = (Local247.rgb * ((MaterialFloat3)Material.PreshaderBuffer[38].x));
	MaterialFloat Local250 = dot(Local249,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local251 = lerp(Local249,((MaterialFloat3)Local250),Material.PreshaderBuffer[38].y);
	MaterialFloat3 Local252 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[37].w),((MaterialFloat3)0.00000000),Local251);
	MaterialFloat3 Local253 = (Local252 + Local251);
	MaterialFloat3 Local254 = (Local253 * Material.PreshaderBuffer[39].xyz);
	MaterialFloat3 Local255 = lerp(Local245,Local254,Local197.r);
	MaterialFloat4 Local256 = Texture2DSample(Material_Texture2D_22,GetMaterialSharedSampler(samplerMaterial_Texture2D_22,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7));
	MaterialFloat Local257 = MaterialStoreTexSample(Parameters, Local256, 7);
	MaterialFloat Local258 = PositiveClampedPow(Local256.rgb.b,Material.PreshaderBuffer[39].w);
	MaterialFloat Local259 = (Local258 + Material.PreshaderBuffer[40].x);
	MaterialFloat Local260 = lerp(Local259,Material.PreshaderBuffer[40].y,Local59.r);
	MaterialFloat Local261 = lerp(Local260,Material.PreshaderBuffer[40].z,Local99.r);
	MaterialFloat Local262 = lerp(Local261,Material.PreshaderBuffer[40].w,Local139.r);
	MaterialFloat Local263 = lerp(Local262,Material.PreshaderBuffer[41].x,Local197.r);
	MaterialFloat Local264 = lerp(Material.PreshaderBuffer[41].y,Material.PreshaderBuffer[41].z,Local59.r);
	MaterialFloat Local265 = lerp(Local264,Material.PreshaderBuffer[41].w,Local99.r);
	MaterialFloat Local266 = lerp(Local265,Material.PreshaderBuffer[42].x,Local139.r);
	MaterialFloat Local267 = lerp(Local266,Material.PreshaderBuffer[42].y,Local197.r);
	MaterialFloat Local268 = lerp(Material.PreshaderBuffer[42].w,Material.PreshaderBuffer[42].z,Local25.g);
	MaterialFloat Local269 = lerp(Material.PreshaderBuffer[43].y,Material.PreshaderBuffer[43].x,Local32.g);
	MaterialFloat Local270 = lerp(Local268,Local269,Local59.r);
	MaterialFloat Local271 = lerp(Material.PreshaderBuffer[43].w,Material.PreshaderBuffer[43].z,Local75.g);
	MaterialFloat Local272 = lerp(Local270,Local271,Local99.r);
	MaterialFloat Local273 = lerp(Material.PreshaderBuffer[44].y,Material.PreshaderBuffer[44].x,Local115.g);
	MaterialFloat Local274 = lerp(Local272,Local273,Local139.r);
	MaterialFloat Local275 = lerp(Material.PreshaderBuffer[44].w,Material.PreshaderBuffer[44].z,Local274);
	MaterialFloat Local276 = lerp(Local274,Local275,Local154);
	MaterialFloat Local277 = lerp(Material.PreshaderBuffer[45].y,Material.PreshaderBuffer[45].x,Local169.g);
	MaterialFloat Local278 = lerp(Local276,Local277,Local197.r);
	MaterialFloat Local424 = PositiveClampedPow(Local25.r,Material.PreshaderBuffer[45].z);
	MaterialFloat Local425 = (Local424 + Material.PreshaderBuffer[45].w);
	MaterialFloat Local426 = PositiveClampedPow(Local32.r,Material.PreshaderBuffer[46].x);
	MaterialFloat Local427 = (Local426 + Material.PreshaderBuffer[46].y);
	MaterialFloat Local428 = lerp(Local425,Local427,Local59.r);
	MaterialFloat Local429 = PositiveClampedPow(Local75.r,Material.PreshaderBuffer[46].z);
	MaterialFloat Local430 = (Local429 + Material.PreshaderBuffer[46].w);
	MaterialFloat Local431 = lerp(Local428,Local430,Local99.r);
	MaterialFloat Local432 = PositiveClampedPow(Local115.r,Material.PreshaderBuffer[47].x);
	MaterialFloat Local433 = (Local432 + Material.PreshaderBuffer[47].y);
	MaterialFloat Local434 = lerp(Local431,Local433,Local139.r);
	MaterialFloat Local435 = PositiveClampedPow(Local169.r,Material.PreshaderBuffer[47].z);
	MaterialFloat Local436 = (Local435 + Material.PreshaderBuffer[47].w);
	MaterialFloat Local437 = lerp(Local434,Local436,Local197.r);

	PixelMaterialInputs.EmissiveColor = Local199;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local255;
	PixelMaterialInputs.Metallic = Local263;
	PixelMaterialInputs.Specular = Local267;
	PixelMaterialInputs.Roughness = Local278;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local198;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local437;

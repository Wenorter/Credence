Shader "Unreal/MI_bridge_church_metal_6"
{
    Properties
    {
		...
		Material_Texture2D_3( "Masks (RGBA)", 2D ) = "white" {}
		Material_Texture2D_4( "Grunge_channel_R", 2D ) = "white" {}
		Material_Texture2D_5( "G_channel_Normal", 2D ) = "white" {}
		Material_Texture2D_6( "Grunge_channel_G", 2D ) = "white" {}
		Material_Texture2D_7( "B_channel_Normal", 2D ) = "white" {}
		Material_Texture2D_8( "Grunge_channel_B", 2D ) = "white" {}
		Material_Texture2D_9( "Brightness_all_mask", 2D ) = "white" {}
		Material_Texture2D_10( "Grunge_channel_Ab", 2D ) = "white" {}
		Material_Texture2D_11( "main_layer_Basecolor", 2D ) = "white" {}
		Material_Texture2D_12( "R_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_13( "G_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_14( "B_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_15( "main_layer_Metallic", 2D ) = "white" {}
		Material_Texture2D_16( "R_channel_ORH", 2D ) = "white" {}
		Material_Texture2D_17( "G_channel_ORH", 2D ) = "white" {}
		Material_Texture2D_18( "B_channel_ORH", 2D ) = "white" {}
		...
		UV_Tiling_R_channel( "UV_Tiling_R_channel", Float ) = 20.000000
		...
		UV_Tiling_G_channel( "UV_Tiling_G_channel", Float ) = 20.000000
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 20.000000
		...
		color_tone_R_channel( "color_tone_R_channel", Float ) = -0.032000
		Brightness_R_channel( "Brightness_R_channel", Float ) = 0.411506
		contrast_R_channel( "contrast_R_channel", Float ) = -0.348693
		Tint_base_color_R_channel( "Tint_base_color_R_channel", Color ) = (1.000000, 0.960695, 0.645136, 1.000000 )
		color_tone_G_channel( "color_tone_G_channel", Float ) = 0.122667
		Brightness_G_channel( "Brightness_G_channel", Float ) = 0.066261
		contrast_G_channel( "contrast_G_channel", Float ) = -1.548236
		Tint_base_color_G_channel( "Tint_base_color_G_channel", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		color_tone_B_channel( "color_tone_B_channel", Float ) = 0.469333
		Brightness_B_channel( "Brightness_B_channel", Float ) = 0.130667
		contrast_B_channel( "contrast_B_channel", Float ) = 1.715735
		...
		Roughness_max_R_channel( "Roughness_max_R_channel", Float ) = 0.800000
		Roughness_min_G_channel( "Roughness_min_G_channel", Float ) = 0.000000
		Roughness_max_G_channel( "Roughness_max_G_channel", Float ) = 0.800000
		Roughness_min_B_channel( "Roughness_min_B_channel", Float ) = 0.000000
		Roughness_max_B_channel( "Roughness_max_B_channel", Float ) = 0.800000
    ...
    SubShader
    {
        ...
        #include "MI_bridge_church_metal_6.hlsl"

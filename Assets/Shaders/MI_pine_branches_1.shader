Shader "Unreal/MI_pine_branches_1"
{
    Properties
    {
		...
		Material_Texture2D_3( "1_Base_Texture", 2D ) = "white" {}
		Material_Texture2D_4( "2_Masks (Occ,Rough,Met)", 2D ) = "white" {}
		...
		UTG_1_Brightness( "UTG_1_Brightness", Float ) = 1.000000
		...
		Specular_8( "Specular_8", Float ) = 0.150000
		...
		UTG_1_SSS( "UTG_1_SSS", Float ) = 1.000000
    ...
    SubShader
    {
        ...
        #include "MI_pine_branches_1.hlsl"

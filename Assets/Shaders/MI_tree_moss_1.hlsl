...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,1.000000,0.350000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.000000,0.150000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6].y = Specular_9;

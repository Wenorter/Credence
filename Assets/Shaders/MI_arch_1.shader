Shader "Unreal/MI_arch_1"
{
    Properties
    {
		...
		Material_Texture2D_17( "wave_normal_texture", 2D ) = "white" {}
		Material_Texture2D_18( "main_layer_Basecolor", 2D ) = "white" {}
		...
		Material_Texture2D_22( "TopTint_layer_Basecolor", 2D ) = "white" {}
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 11.000000
		...
		B_channel_blend( "B_channel_blend", Float ) = 3.000000
		...
		Shift_side_Y_TopTint_layer( "Shift_side_Y_TopTint_layer", Float ) = 0.000000
		Tiling_coordinate_Y_TopTint_layer( "Tiling_coordinate_Y_TopTint_layer", Float ) = 1.000000
		Tiling_TopTint_layer( "Tiling_TopTint_layer", Float ) = 0.500000
		Shift_side_X_TopTint_layer( "Shift_side_X_TopTint_layer", Float ) = 0.000000
		Tiling_coordinate_X_TopTint_layer( "Tiling_coordinate_X_TopTint_layer", Float ) = 1.000000
		Seam_hardness_TopTint_layer( "Seam_hardness_TopTint_layer", Float ) = 1.000000
		Shift_side_Z_TopTint_layer( "Shift_side_Z_TopTint_layer", Float ) = 0.000000
		Tiling_coordinate_Z_TopTint_layer( "Tiling_coordinate_Z_TopTint_layer", Float ) = 1.000000
		...
		BlendSharp_2( "BlendSharp_2", Float ) = 3.221240
		BlendSharp_1( "BlendSharp_1", Float ) = 5.000000
		Tiling_noise_AWP( "Tiling_noise_AWP", Float ) = 5.000000
		noise_power( "noise_power", Float ) = 1.000000
		wave_speed( "wave_speed", Float ) = 0.001000
		wave_scale( "wave_scale", Float ) = 1.000000
		wave_Normal_int( "wave_Normal_int", Float ) = 0.100000
		getting_wet_depth( "getting_wet_depth", Float ) = 1.000000
		getting_wet_Height_setting( "getting_wet_Height_setting", Float ) = 1.000000
		layer_getting_wet_contrast( "layer_getting_wet_contrast", Float ) = 1.000000
		layer_getting_wet_blend( "layer_getting_wet_blend", Float ) = 0.000000
		layer_getting_wet_extend( "layer_getting_wet_extend", Float ) = 4.000000
		...
		Brightness_B_all_mask( "Brightness_B_all_mask", Float ) = 0.500000
		...
		getting_wet_color_depth( "getting_wet_color_depth", Color ) = (0.000000, 0.000000, 0.000000, 1.000000 )
		wetness_limit( "wetness_limit", Float ) = -0.800000
		wetness_limit_bloom( "wetness_limit_bloom", Float ) = -0.950000
		getting_wet_color( "getting_wet_color", Color ) = (0.009258, 0.044271, 0.040740, 1.000000 )
		getting_wet_opacity( "getting_wet_opacity", Float ) = 1.000000
		getting_wet_contrast( "getting_wet_contrast", Float ) = 1.000000
		...
		getting_wet_Roughness_bloom( "getting_wet_Roughness_bloom", Float ) = 1.000000
		getting_wet_Roughness( "getting_wet_Roughness", Float ) = 0.000000

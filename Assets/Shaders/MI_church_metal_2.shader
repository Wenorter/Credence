Shader "Unreal/MI_church_metal_2"
{
    Properties
    {
		...
		UV_Tiling_main_layer( "UV_Tiling_main_layer", Float ) = 12.000000
		...
		UV_Tiling_R_channel( "UV_Tiling_R_channel", Float ) = 12.000000
		...
		UV_Tiling_G_channel( "UV_Tiling_G_channel", Float ) = 12.000000
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 12.000000
		...
		Brightness_B_all_mask( "Brightness_B_all_mask", Float ) = 0.724000
    ...
    SubShader
    {
        ...
        #include "MI_church_metal_2.hlsl"

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.518667,0.350000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.000000,0.150000,0.708000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1.000000,3.000000,0.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6].y = Specular_10;
	...
	Material.PreshaderBuffer[7].y = UTG_1_SSS;
	Material.PreshaderBuffer[7].z = __SubsurfaceProfile;
	Material.PreshaderBuffer[7].w = UTG_2_AO_power;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local34 = (Local26 * ((MaterialFloat3)Material.PreshaderBuffer[7].y));
	MaterialFloat Local35 = PositiveClampedPow(Local28.r,Material.PreshaderBuffer[7].w);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local34,Material.PreshaderBuffer[7].z);

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[12] = float4(1.000000,200.000000,4.000000,2.000000);//(Unknown)
	...
	Material.PreshaderBuffer[20] = float4(0.664000,0.336000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[30] = float4(0.608000,0.000000,0.000000,0.000000);//(Unknown)

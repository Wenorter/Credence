...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2].y = SelectionColor.w;
	Material.PreshaderBuffer[3].xyz = SelectionColor.xyz;
	Material.PreshaderBuffer[3].w = color_tone_main_layer * 6.283;
	Material.PreshaderBuffer[4].x = Brightness_main_layer;
	Material.PreshaderBuffer[4].y = contrast_main_layer;
	Material.PreshaderBuffer[5].xyz = Tint_base_color_main_layer.xyz;
	Material.PreshaderBuffer[5].w = Metallic_main_layer;
	Material.PreshaderBuffer[6].x = Specular_main_layer;
	Material.PreshaderBuffer[6].y = Roughness_max_main_layer;
	Material.PreshaderBuffer[6].z = Roughness_min_main_layer;
	Material.PreshaderBuffer[6].w = AO_Contrast_main_layer;
	Material.PreshaderBuffer[7].x = 1 - AO_Intensity_main_layer;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local22 = (Local21 * Material.PreshaderBuffer[5].xyz);
	MaterialFloat Local23 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 7);
	MaterialFloat4 Local24 = Texture2DSample(Material_Texture2D_2,GetMaterialSharedSampler(samplerMaterial_Texture2D_2,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7));
	MaterialFloat Local25 = MaterialStoreTexSample(Parameters, Local24, 7);
	MaterialFloat Local26 = lerp(Material.PreshaderBuffer[6].z,Material.PreshaderBuffer[6].y,Local24.g);
	MaterialFloat Local27 = PositiveClampedPow(Local24.r,Material.PreshaderBuffer[6].w);
	MaterialFloat Local28 = (Local27 + Material.PreshaderBuffer[7].x);

	PixelMaterialInputs.EmissiveColor = Local13;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local22;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[5].w;

...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6].y = Specular_0;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local33 = lerp(Local19.a,1.00000000,0.50000000);
	MaterialFloat Local34 = (Local33 * Material.PreshaderBuffer[7].x);
	MaterialFloat3 Local35 = (Local26 * ((MaterialFloat3)Material.PreshaderBuffer[7].y));
	MaterialFloat Local36 = PositiveClampedPow(Local28.r,Material.PreshaderBuffer[7].w);

	PixelMaterialInputs.EmissiveColor = Local17;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local34;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local35,Material.PreshaderBuffer[7].z);
	PixelMaterialInputs.AmbientOcclusion = Local36;

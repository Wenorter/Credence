Shader "Unreal/MI_bricks_1"
{
    Properties
    {
		...
		Material_Texture2D_3( "Grunge_channel_R", 2D ) = "white" {}
		Material_Texture2D_4( "TopTint_layer_Normal", 2D ) = "white" {}
		Material_Texture2D_5( "TopTint_layer_ORH", 2D ) = "white" {}
		Material_Texture2D_6( "Noise_moss", 2D ) = "white" {}
		Material_Texture2D_7( "main_layer_Basecolor", 2D ) = "white" {}
		Material_Texture2D_8( "R_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_9( "TopTint_layer_Basecolor", 2D ) = "white" {}
		Material_Texture2D_10( "main_layer_ORH", 2D ) = "white" {}
		Material_Texture2D_11( "R_channel_ORH", 2D ) = "white" {}
		...
		UV_Tiling_main_layer( "UV_Tiling_main_layer", Float ) = 1.500000
		...
		UV_Tiling_R_channel( "UV_Tiling_R_channel", Float ) = 1.000000
		...
		R_channel_contrast( "R_channel_contrast", Float ) = -0.042667
		...
		Grunge_tiling_R_channel( "Grunge_tiling_R_channel", Float ) = 0.200000
		Grunge_channel_R_power( "Grunge_channel_R_power", Float ) = 80.000000
		...
		UV_Tiling_TopTint_layer( "UV_Tiling_TopTint_layer", Float ) = 4.500000
		...
		TopTint_layer_contrast( "TopTint_layer_contrast", Float ) = 0.009699
		Disp_Contrast_TopTint_layer( "Disp_Contrast_TopTint_layer", Float ) = 0.000000
		Disp_Intensity_TopTint_layer( "Disp_Intensity_TopTint_layer", Float ) = 0.050000
		TopTint_layer_blend( "TopTint_layer_blend", Float ) = 1.000000
		TopTint_layer_extend( "TopTint_layer_extend", Float ) = 0.762994
		BlendSharp_2( "BlendSharp_2", Float ) = 2.326780
		BlendSharp_1( "BlendSharp_1", Float ) = 4.708986
		...
		Brightness_main_layer( "Brightness_main_layer", Float ) = 0.963113
		contrast_main_layer( "contrast_main_layer", Float ) = 0.078000
		Tint_base_color_main_layer( "Tint_base_color_main_layer", Color ) = (1.000000, 0.973828, 0.976319, 1.000000 )
		color_tone_R_channel( "color_tone_R_channel", Float ) = 0.000000
		Brightness_R_channel( "Brightness_R_channel", Float ) = 0.552000
		...
		Brightness_TopTint_layer( "Brightness_TopTint_layer", Float ) = 0.612000

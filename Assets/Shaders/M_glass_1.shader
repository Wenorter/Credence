Shader "Unreal/M_glass_1"
{
    Properties
    {
		...
		color_2_emissive( "color_2_emissive", Float ) = 0.000000
		tint_emissive( "tint_emissive", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Emissive_power( "Emissive_power", Float ) = 0.000000
		color_1_emissive( "color_1_emissive", Float ) = 0.000000
		...
		UTG_2_metal_power( "UTG_2_metal_power", Float ) = 1.000000
		Specular_17( "Specular_17", Float ) = 0.150000
		UTG_2_Roughness_min( "UTG_2_Roughness_min", Float ) = 0.000000
		UTG_2_Roughness_max( "UTG_2_Roughness_max", Float ) = 1.000000
		Opacity_mask( "Opacity_mask", Float ) = 0.000000
		Opacity_Min( "Opacity_Min", Float ) = 0.200000
		Opacity_Max( "Opacity_Max", Float ) = 0.350000
		Fresnel_Exponent( "Fresnel_Exponent", Float ) = 5.000000
		Fresnel_Base_Reflection_Fraction( "Fresnel_Base_Reflection_Fraction", Float ) = 0.040000
		Glass_Overall_Opacity( "Glass_Overall_Opacity", Float ) = 0.000000
		bloor_opacity_mask( "bloor_opacity_mask", Float ) = 0.000000
		power_opacity_mask( "power_opacity_mask", Float ) = 1.000000
		UTG_2_AO_power( "UTG_2_AO_power", Float ) = 1.000000
		Refraction( "Refraction", Float ) = 1.000000
		Refraction_Over( "Refraction_Over", Float ) = 0.000000

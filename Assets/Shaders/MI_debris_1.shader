Shader "Unreal/MI_debris_1"
{
    Properties
    {
		...
		UVmask_R_opacity( "UVmask_R_opacity", Float ) = 0.000000
		...
		UVmask_G_opacity( "UVmask_G_opacity", Float ) = 0.000000
		UVmask_B_opacity_bloor( "UVmask_B_opacity_bloor", Float ) = 1.000000
		UVmask_B_opacity( "UVmask_B_opacity", Float ) = 0.000000
		...
		Tiling_moss( "Tiling_moss", Float ) = 1.000000
		Normal_moss( "Normal_moss", Float ) = 1.000000
		TopTint_normal( "TopTint_normal", Float ) = 0.000000
		BlendSharp_2( "BlendSharp_2", Float ) = 3.364401
		BlendSharp_1( "BlendSharp_1", Float ) = 2.665312
		Tiling_noise( "Tiling_noise", Float ) = 2.000000
		...
		UTG_1_Brightness( "UTG_1_Brightness", Float ) = 0.750000
		UTG_1_contrast( "UTG_1_contrast", Float ) = -0.500000
		tint_moss( "tint_moss", Vector ) = (0.916667, 0.875790, 0.816406, 1.000000 )
		color_2_moss( "color_2_moss", Float ) = 0.000000
		Brightness_moss( "Brightness_moss", Float ) = 0.918018
		color_1_moss( "color_1_moss", Float ) = 0.000000
		...
		metal_power_moss( "metal_power_moss", Float ) = 1.000000
		Specular_14( "Specular_14", Float ) = 0.150000
		UTG_2_Roughness_min( "UTG_2_Roughness_min", Float ) = 0.000000
		UTG_2_Roughness_max( "UTG_2_Roughness_max", Float ) = 1.000000
		Rough_min_moss( "Rough_min_moss", Float ) = 0.000000
		Rough_max_moss( "Rough_max_moss", Float ) = 1.000000
		...
		AO_power_moss( "AO_power_moss", Float ) = 1.000000

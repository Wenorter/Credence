...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[10] = float4(0.000000,0.150000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,1.000000,0.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6].xyz = emissive_color.xyz * emissive_power;
	Material.PreshaderBuffer[6].w = SelectionColor.w;
	Material.PreshaderBuffer[7].xyz = SelectionColor.xyz;
	Material.PreshaderBuffer[7].w = UTG_1_color_tone * 6.283;
	Material.PreshaderBuffer[8].x = UTG_1_Brightness;
	Material.PreshaderBuffer[8].y = UTG_1_contrast;
	Material.PreshaderBuffer[9].xyz = UTG_1_Tint_base_texture.xyz;
	Material.PreshaderBuffer[9].w = Metallic_Contrast_main_layer;
	Material.PreshaderBuffer[10].x = 1 - Metallic_Intensity_main_layer;
	Material.PreshaderBuffer[10].y = Specular_8;
	Material.PreshaderBuffer[10].z = UTG_2_Roughness_max;
	Material.PreshaderBuffer[10].w = UTG_2_Roughness_min;
	Material.PreshaderBuffer[11].x = UTG_4_Opacity_Mask_power;
	Material.PreshaderBuffer[11].y = UTG_1_SSS;
	Material.PreshaderBuffer[11].z = __SubsurfaceProfile;
	Material.PreshaderBuffer[11].w = UTG_2_AO_power;
}
...
SHADER_DISABLE_WARNINGS
	...
	PixelMaterialInputs.Normal = Local52;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local53 = lerp(Material.PreshaderBuffer[6].xyz,Material.PreshaderBuffer[7].xyz,Material.PreshaderBuffer[6].w);
	MaterialFloat Local54 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 0);
	MaterialFloat4 Local55 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_3,GetMaterialSharedSampler(samplerMaterial_Texture2D_3,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7)));
	MaterialFloat Local56 = MaterialStoreTexSample(Parameters, Local55, 0);
	MaterialFloat3 Local57 = (Local55.rgb * ((MaterialFloat3)Material.PreshaderBuffer[8].x));
	MaterialFloat Local58 = dot(Local57,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	MaterialFloat3 Local59 = lerp(Local57,((MaterialFloat3)Local58),Material.PreshaderBuffer[8].y);
	MaterialFloat3 Local60 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000).rgb),Material.PreshaderBuffer[7].w),((MaterialFloat3)0.00000000),Local59);
	MaterialFloat3 Local61 = (Local60 + Local59);
	MaterialFloat3 Local62 = (Material.PreshaderBuffer[9].xyz * Local61);
	MaterialFloat3 Local63 = lerp(Local62,((MaterialFloat3)1.00000000),Local30);
	MaterialFloat3 Local64 = lerp(Local63,((MaterialFloat3)1.00000000),Local37);
	MaterialFloat3 Local65 = lerp(Local64,((MaterialFloat3)1.00000000),Local44);
	MaterialFloat3 Local66 = lerp(Local65,((MaterialFloat3)1.00000000),Local51);
	MaterialFloat Local67 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 1);
	MaterialFloat4 Local68 = Texture2DSample(Material_Texture2D_4,GetMaterialSharedSampler(samplerMaterial_Texture2D_4,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7));
	MaterialFloat Local69 = MaterialStoreTexSample(Parameters, Local68, 1);
	MaterialFloat Local70 = PositiveClampedPow(Local68.b,Material.PreshaderBuffer[9].w);
	MaterialFloat Local71 = (Local70 + Material.PreshaderBuffer[10].x);
	MaterialFloat Local72 = lerp(Local71,1.00000000,Local30);
	MaterialFloat Local73 = lerp(Local72,1.00000000,Local37);
	MaterialFloat Local74 = lerp(Local73,1.00000000,Local44);
	MaterialFloat Local75 = lerp(Local74,1.00000000,Local51);
	MaterialFloat Local76 = lerp(Material.PreshaderBuffer[10].w,Material.PreshaderBuffer[10].z,Local68.g);
	MaterialFloat Local77 = lerp(Local76,1.00000000,Local30);
	MaterialFloat Local78 = lerp(Local77,1.00000000,Local37);
	MaterialFloat Local79 = lerp(Local78,1.00000000,Local44);
	MaterialFloat Local80 = lerp(Local79,1.00000000,Local51);
	MaterialFloat Local81 = (Local55.a * Material.PreshaderBuffer[11].x);
	MaterialFloat3 Local82 = (Local66 * ((MaterialFloat3)Material.PreshaderBuffer[11].y));
	MaterialFloat Local83 = PositiveClampedPow(Local68.r,Material.PreshaderBuffer[11].w);
	MaterialFloat Local84 = lerp(Local83,1.00000000,Local30);
	MaterialFloat Local85 = lerp(Local84,1.00000000,Local37);
	MaterialFloat Local86 = lerp(Local85,1.00000000,Local44);
	MaterialFloat Local87 = lerp(Local86,1.00000000,Local51);

	PixelMaterialInputs.EmissiveColor = Local53;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local81;
	PixelMaterialInputs.BaseColor = Local66;
	PixelMaterialInputs.Metallic = Local75;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[10].y;
	PixelMaterialInputs.Roughness = Local80;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local52;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local82,Material.PreshaderBuffer[11].z);
	PixelMaterialInputs.AmbientOcclusion = Local87;

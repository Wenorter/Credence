Shader "Unreal/MI_tree_moss_2"
{
    Properties
    {
		...
		UTG_1_Brightness( "UTG_1_Brightness", Float ) = 0.518667
		UTG_1_contrast( "UTG_1_contrast", Float ) = 0.350000
		...
		Specular_10( "Specular_10", Float ) = 0.150000
		UTG_2_Roughness_min( "UTG_2_Roughness_min", Float ) = 0.000000
		UTG_2_Roughness_max( "UTG_2_Roughness_max", Float ) = 0.708000
		UTG_4_Opacity_Mask_power( "UTG_4_Opacity_Mask_power", Float ) = 1.000000
		UTG_1_SSS( "UTG_1_SSS", Float ) = 3.000000

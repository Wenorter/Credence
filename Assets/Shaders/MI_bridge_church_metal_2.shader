Shader "Unreal/MI_bridge_church_metal_2"
{
    Properties
    {
		...
		UV_Tiling_main_layer( "UV_Tiling_main_layer", Float ) = 15.000000
		...
		UV_Tiling_G_channel( "UV_Tiling_G_channel", Float ) = 15.000000
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 15.000000
		...
		Brightness_main_layer( "Brightness_main_layer", Float ) = 0.700000
		...
		Brightness_R_channel( "Brightness_R_channel", Float ) = 0.560000
		...
		color_tone_G_channel( "color_tone_G_channel", Float ) = -0.937404
		Brightness_G_channel( "Brightness_G_channel", Float ) = 0.452927
		...
		color_tone_B_channel( "color_tone_B_channel", Float ) = 0.044000
    ...
    SubShader
    {
        ...
        #include "MI_bridge_church_metal_2.hlsl"

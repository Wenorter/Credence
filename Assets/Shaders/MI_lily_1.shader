Shader "Unreal/MI_lily_1"
{
    Properties
    {
		...
		UTG_1_color_tone( "UTG_1_color_tone", Float ) = -0.144000
		UTG_1_Brightness( "UTG_1_Brightness", Float ) = 0.464000
		UTG_1_contrast( "UTG_1_contrast", Float ) = 0.096000
		...
		Specular_13( "Specular_13", Float ) = 0.150000
		UTG_2_Roughness_min( "UTG_2_Roughness_min", Float ) = 0.000000
		UTG_2_Roughness_max( "UTG_2_Roughness_max", Float ) = 0.250934
		UTG_4_Opacity_Mask_power( "UTG_4_Opacity_Mask_power", Float ) = 0.500000
		speed_X( "speed_X", Float ) = 1.000000
		displacement_force_X( "displacement_force_X", Float ) = 10.000000
		amplitude_X( "amplitude_X", Float ) = 0.500000
		speed_Y( "speed_Y", Float ) = 1.000000
		displacement_force_Y( "displacement_force_Y", Float ) = 0.000000
		amplitude_Y( "amplitude_Y", Float ) = 0.500000
		speed_Z( "speed_Z", Float ) = 0.000000
		displacement_force_Z( "displacement_force_Z", Float ) = 1.000000
		amplitude_Z( "amplitude_Z", Float ) = 0.000000
		UTG_1_SSS( "UTG_1_SSS", Float ) = 0.500000

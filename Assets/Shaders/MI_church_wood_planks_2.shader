Shader "Unreal/MI_church_wood_planks_2"
{
    Properties
    {
		...
		Grunge_channel_R_power( "Grunge_channel_R_power", Float ) = 33.000000
		...
		Grunge_tiling_G_channel( "Grunge_tiling_G_channel", Float ) = 50.000000
		Grunge_channel_G_power( "Grunge_channel_G_power", Float ) = 33.000000
		...
		Grunge_channel_B_power( "Grunge_channel_B_power", Float ) = 33.000000
    ...
    SubShader
    {
        ...
        #include "MI_church_wood_planks_2.hlsl"

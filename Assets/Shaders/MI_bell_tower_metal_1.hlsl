...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,6.000000,6.000000);//(Unknown)
	...
	Material.PreshaderBuffer[4] = float4(6.000000,6.000000,5.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[10] = float4(6.000000,6.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[15] = float4(0.000000,0.000000,6.000000,6.000000);//(Unknown)
	...
	Material.PreshaderBuffer[24] = float4(0.200000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[25] = float4(1.000000,1.000000,1.000000,-6.170107);//(Unknown)
	Material.PreshaderBuffer[26] = float4(0.828927,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[27] = float4(1.000000,1.000000,1.000000,0.502655);//(Unknown)
	Material.PreshaderBuffer[28] = float4(0.632000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[29] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[34] = float4(0.150000,0.150000,0.150000,0.150000);//(Unknown)
	...
	Material.PreshaderBuffer[37] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[38] = float4(1.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[39] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[32].w = Metallic_Contrast_main_layer;
	Material.PreshaderBuffer[33].x = 1 - Metallic_Intensity_main_layer;
	Material.PreshaderBuffer[33].y = Metallic_R_channel;
	Material.PreshaderBuffer[33].z = Metallic_G_channel;
	Material.PreshaderBuffer[33].w = Metallic_B_channel;
	Material.PreshaderBuffer[34].x = Specular_main_layer;
	Material.PreshaderBuffer[34].y = Specular_R_channel;
	Material.PreshaderBuffer[34].z = Specular_G_channel;
	Material.PreshaderBuffer[34].w = Specular_B_channel;
	Material.PreshaderBuffer[35].x = Roughness_max_main_layer;
	Material.PreshaderBuffer[35].y = Roughness_min_main_layer;
	Material.PreshaderBuffer[35].z = Roughness_max_R_channel;
	Material.PreshaderBuffer[35].w = Roughness_min_R_channel;
	Material.PreshaderBuffer[36].x = Roughness_max_G_channel;
	Material.PreshaderBuffer[36].y = Roughness_min_G_channel;
	Material.PreshaderBuffer[36].z = Roughness_max_B_channel;
	Material.PreshaderBuffer[36].w = Roughness_min_B_channel;
	Material.PreshaderBuffer[37].x = Roughness_max_B_all_mask;
	Material.PreshaderBuffer[37].y = Roughness_min_B_all_mask;
	Material.PreshaderBuffer[37].z = AO_Contrast_main_layer;
	Material.PreshaderBuffer[37].w = 1 - AO_Intensity_main_layer;
	Material.PreshaderBuffer[38].x = AO_Contrast_R_channel;
	Material.PreshaderBuffer[38].y = 1 - AO_Intensity_R_channel;
	Material.PreshaderBuffer[38].z = AO_Contrast_G_channel;
	Material.PreshaderBuffer[38].w = 1 - AO_Intensity_G_channel;
	Material.PreshaderBuffer[39].x = AO_Contrast_B_channel;
	Material.PreshaderBuffer[39].y = 1 - AO_Intensity_B_channel;
}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local160 = dot(Local159,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	...
	MaterialFloat Local169 = dot(Local168,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	...
	MaterialFloat Local179 = dot(Local178,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	...
	MaterialFloat Local189 = dot(Local188,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	...
	MaterialFloat Local196 = dot(Local195,MaterialFloat3(0.21263900,0.71516865,0.07219232));
	...
	MaterialFloat4 Local202 = Texture2DSample(Material_Texture2D_18,GetMaterialSharedSampler(samplerMaterial_Texture2D_18,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local7));
	MaterialFloat Local203 = MaterialStoreTexSample(Parameters, Local202, 7);
	MaterialFloat Local204 = PositiveClampedPow(Local202.rgb.b,Material.PreshaderBuffer[32].w);
	MaterialFloat Local205 = (Local204 + Material.PreshaderBuffer[33].x);
	MaterialFloat Local206 = lerp(Local205,Material.PreshaderBuffer[33].y,Local59.r);
	MaterialFloat Local207 = lerp(Local206,Material.PreshaderBuffer[33].z,Local99.r);
	MaterialFloat Local208 = lerp(Local207,Material.PreshaderBuffer[33].w,Local139.r);
	MaterialFloat Local209 = lerp(Material.PreshaderBuffer[34].x,Material.PreshaderBuffer[34].y,Local59.r);
	MaterialFloat Local210 = lerp(Local209,Material.PreshaderBuffer[34].z,Local99.r);
	MaterialFloat Local211 = lerp(Local210,Material.PreshaderBuffer[34].w,Local139.r);
	MaterialFloat Local212 = lerp(Material.PreshaderBuffer[35].y,Material.PreshaderBuffer[35].x,Local25.g);
	MaterialFloat Local213 = lerp(Material.PreshaderBuffer[35].w,Material.PreshaderBuffer[35].z,Local32.g);
	MaterialFloat Local214 = lerp(Local212,Local213,Local59.r);
	MaterialFloat Local215 = lerp(Material.PreshaderBuffer[36].y,Material.PreshaderBuffer[36].x,Local75.g);
	MaterialFloat Local216 = lerp(Local214,Local215,Local99.r);
	MaterialFloat Local217 = lerp(Material.PreshaderBuffer[36].w,Material.PreshaderBuffer[36].z,Local115.g);
	MaterialFloat Local218 = lerp(Local216,Local217,Local139.r);
	MaterialFloat Local219 = lerp(Material.PreshaderBuffer[37].y,Material.PreshaderBuffer[37].x,Local218);
	MaterialFloat Local220 = lerp(Local218,Local219,Local154);
	MaterialFloat Local333 = PositiveClampedPow(Local25.r,Material.PreshaderBuffer[37].z);
	MaterialFloat Local334 = (Local333 + Material.PreshaderBuffer[37].w);
	MaterialFloat Local335 = PositiveClampedPow(Local32.r,Material.PreshaderBuffer[38].x);
	MaterialFloat Local336 = (Local335 + Material.PreshaderBuffer[38].y);
	MaterialFloat Local337 = lerp(Local334,Local336,Local59.r);
	MaterialFloat Local338 = PositiveClampedPow(Local75.r,Material.PreshaderBuffer[38].z);
	MaterialFloat Local339 = (Local338 + Material.PreshaderBuffer[38].w);
	MaterialFloat Local340 = lerp(Local337,Local339,Local99.r);
	MaterialFloat Local341 = PositiveClampedPow(Local115.r,Material.PreshaderBuffer[39].x);
	MaterialFloat Local342 = (Local341 + Material.PreshaderBuffer[39].y);
	MaterialFloat Local343 = lerp(Local340,Local342,Local139.r);

	PixelMaterialInputs.EmissiveColor = Local155;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local201;
	PixelMaterialInputs.Metallic = Local208;
	PixelMaterialInputs.Specular = Local211;
	PixelMaterialInputs.Roughness = Local220;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local140;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local343;

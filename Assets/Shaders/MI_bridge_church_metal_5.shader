Shader "Unreal/MI_bridge_church_metal_5"
{
    Properties
    {
		...
		Brightness_main_layer( "Brightness_main_layer", Float ) = 0.750000
		...
		Brightness_R_channel( "Brightness_R_channel", Float ) = 0.400000
    ...
    SubShader
    {
        ...
        #include "MI_bridge_church_metal_5.hlsl"

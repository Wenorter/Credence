Shader "Unreal/MI_church_wall_2"
{
    Properties
    {
		...
		Material_Texture2D_1( "BCmask_Basecolor", 2D ) = "white" {}
		Material_Texture2D_2( "R_channel_Normal", 2D ) = "white" {}
		Material_Texture2D_3( "main_layer_ORH", 2D ) = "white" {}
		Material_Texture2D_4( "R_channel_ORH", 2D ) = "white" {}
		Material_Texture2D_5( "Masks (RGBA)", 2D ) = "white" {}
		Material_Texture2D_6( "Grunge_channel_R", 2D ) = "white" {}
		Material_Texture2D_7( "G_channel_Normal", 2D ) = "white" {}
		Material_Texture2D_8( "G_channel_ORH", 2D ) = "white" {}
		Material_Texture2D_9( "Grunge_channel_G", 2D ) = "white" {}
		Material_Texture2D_10( "B_channel_Normal", 2D ) = "white" {}
		Material_Texture2D_11( "B_channel_ORH", 2D ) = "white" {}
		Material_Texture2D_12( "Grunge_channel_B", 2D ) = "white" {}
		Material_Texture2D_13( "Brightness_all_mask", 2D ) = "white" {}
		Material_Texture2D_14( "Grunge_channel_Ab", 2D ) = "white" {}
		Material_Texture2D_15( "main_layer_Basecolor", 2D ) = "white" {}
		Material_Texture2D_16( "BCmask_layer_1_Basecolor", 2D ) = "white" {}
		Material_Texture2D_17( "BCmask_layer_2_Basecolor", 2D ) = "white" {}
		Material_Texture2D_18( "BCmask_layer_3_Basecolor", 2D ) = "white" {}
		Material_Texture2D_19( "R_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_20( "G_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_21( "B_channel_Basecolor", 2D ) = "white" {}
		...
		threshold_BCmask_layer_1( "threshold_BCmask_layer_1", Float ) = 2.000000
		color_mask_BCmask_layer_1( "color_mask_BCmask_layer_1", Color ) = (0.891387, 0.000000, 0.984000, 1.000000 )
		threshold_BCmask_layer_2( "threshold_BCmask_layer_2", Float ) = 1.000000
		color_mask_BCmask_layer_2( "color_mask_BCmask_layer_2", Color ) = (0.967448, 0.000000, 0.000000, 1.000000 )
		threshold_BCmask_layer_3( "threshold_BCmask_layer_3", Float ) = 0.300000
		color_mask_BCmask_layer_3( "color_mask_BCmask_layer_3", Color ) = (0.000000, 0.000000, 1.000000, 1.000000 )
		...
		UV_Tiling_R_channel( "UV_Tiling_R_channel", Float ) = 10.000000
		...
		Disp_Contrast_R_channel( "Disp_Contrast_R_channel", Float ) = -0.580000
		...
		Disp_Contrast_G_channel( "Disp_Contrast_G_channel", Float ) = -0.244000
		...
		Grunge_tiling_G_channel( "Grunge_tiling_G_channel", Float ) = 150.000000
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 19.000000
		...
		B_channel_contrast( "B_channel_contrast", Float ) = 10.000000
		...
		B_channel_blend( "B_channel_blend", Float ) = 3.318073
		B_channel_extend( "B_channel_extend", Float ) = -0.658752
		...
		UVmask_Ab_opacity_bloor( "UVmask_Ab_opacity_bloor", Float ) = 1.000000
		...
		color_tone_main_layer( "color_tone_main_layer", Float ) = 1.000000
		...
		color_tone_BCmask_layer_1( "color_tone_BCmask_layer_1", Float ) = 0.000000
		Rotation_custom_BCmask_layer_1( "Rotation_custom_BCmask_layer_1", Float ) = 0.000000
		U_tile_BCmask_layer_1( "U_tile_BCmask_layer_1", Float ) = 0.000000
		V_tile_BCmask_layer_1( "V_tile_BCmask_layer_1", Float ) = 0.000000
		UV_Tiling_BCmask_layer_1( "UV_Tiling_BCmask_layer_1", Float ) = 1.000000
		Base_UV___U_Tiling_BCmask_layer_1( "Base_UV___U_Tiling_BCmask_layer_1", Float ) = 1.000000
		Base_UV___V_Tiling_BCmask_layer_1( "Base_UV___V_Tiling_BCmask_layer_1", Float ) = 1.000000
		Brightness_BCmask_layer_1( "Brightness_BCmask_layer_1", Float ) = 0.455472
		contrast_BCmask_layer_1( "contrast_BCmask_layer_1", Float ) = 0.000000
		Tint_base_color_BCmask_layer_1( "Tint_base_color_BCmask_layer_1", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		color_tone_BCmask_layer_2( "color_tone_BCmask_layer_2", Float ) = 0.000000
		Rotation_custom_BCmask_layer_2( "Rotation_custom_BCmask_layer_2", Float ) = 0.000000
		U_tile_BCmask_layer_2( "U_tile_BCmask_layer_2", Float ) = 0.000000
		V_tile_BCmask_layer_2( "V_tile_BCmask_layer_2", Float ) = 0.000000
		UV_Tiling_BCmask_layer_2( "UV_Tiling_BCmask_layer_2", Float ) = 1.000000
		Base_UV___U_Tiling_BCmask_layer_2( "Base_UV___U_Tiling_BCmask_layer_2", Float ) = 1.000000
		Base_UV___V_Tiling_BCmask_layer_2( "Base_UV___V_Tiling_BCmask_layer_2", Float ) = 1.000000
		Brightness_BCmask_layer_2( "Brightness_BCmask_layer_2", Float ) = 0.536000
		contrast_BCmask_layer_2( "contrast_BCmask_layer_2", Float ) = 0.000000
		Tint_base_color_BCmask_layer_2( "Tint_base_color_BCmask_layer_2", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		color_tone_BCmask_layer_3( "color_tone_BCmask_layer_3", Float ) = 0.000000
		Rotation_custom_BCmask_layer_3( "Rotation_custom_BCmask_layer_3", Float ) = 0.000000
		U_tile_BCmask_layer_3( "U_tile_BCmask_layer_3", Float ) = 0.000000
		V_tile_BCmask_layer_3( "V_tile_BCmask_layer_3", Float ) = 0.000000
		UV_Tiling_BCmask_layer_3( "UV_Tiling_BCmask_layer_3", Float ) = 10.000000
		Base_UV___U_Tiling_BCmask_layer_3( "Base_UV___U_Tiling_BCmask_layer_3", Float ) = 1.000000
		Base_UV___V_Tiling_BCmask_layer_3( "Base_UV___V_Tiling_BCmask_layer_3", Float ) = 1.000000
		Brightness_BCmask_layer_3( "Brightness_BCmask_layer_3", Float ) = 0.488000
		contrast_BCmask_layer_3( "contrast_BCmask_layer_3", Float ) = 0.000000
		Tint_base_color_BCmask_layer_3( "Tint_base_color_BCmask_layer_3", Color ) = (0.588163, 0.794290, 1.000000, 1.000000 )
		...
		Brightness_B_all_mask( "Brightness_B_all_mask", Float ) = 0.720000
		contrast_B_all_mask( "contrast_B_all_mask", Float ) = 0.000000
		Tint_base_color_B_all_mask( "Tint_base_color_B_all_mask", Color ) = (1.000000, 0.957842, 0.933594, 1.000000 )
		...
		Roughness_min_BCmask_layer_1( "Roughness_min_BCmask_layer_1", Float ) = 0.000000
		Roughness_max_BCmask_layer_1( "Roughness_max_BCmask_layer_1", Float ) = 1.000000
		Roughness_min_BCmask_layer_2( "Roughness_min_BCmask_layer_2", Float ) = 0.000000
		Roughness_max_BCmask_layer_2( "Roughness_max_BCmask_layer_2", Float ) = 1.000000
		Roughness_min_BCmask_layer_3( "Roughness_min_BCmask_layer_3", Float ) = 0.000000
		Roughness_max_BCmask_layer_3( "Roughness_max_BCmask_layer_3", Float ) = 1.000000

Shader "Unreal/M_Main_master"
{
    Properties
    {
		...
		Material_Texture2D_1( "main_layer_Basecolor", 2D ) = "white" {}
		...
		UV_Tiling_main_layer( "UV_Tiling_main_layer", Float ) = 1.000000

Shader "Unreal/MI_bell_tower_wall_1"
{
    Properties
    {
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 17.000000
		...
		B_channel_extend( "B_channel_extend", Float ) = 1.799755
		...
		UVmask_Ab_opacity_bloor( "UVmask_Ab_opacity_bloor", Float ) = -0.400000
		...
		Brightness_B_all_mask( "Brightness_B_all_mask", Float ) = 0.432000
    ...
    SubShader
    {
        ...
        #include "MI_bell_tower_wall_1.hlsl"

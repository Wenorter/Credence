Shader "Unreal/MI_church_metal_1"
{
    Properties
    {
		...
		Material_Texture2D_14( "TopTint_layer_Normal", 2D ) = "white" {}
		Material_Texture2D_15( "TopTint_layer_ORH", 2D ) = "white" {}
		Material_Texture2D_16( "Noise_moss", 2D ) = "white" {}
		Material_Texture2D_17( "main_layer_Basecolor", 2D ) = "white" {}
		Material_Texture2D_18( "R_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_19( "G_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_20( "B_channel_Basecolor", 2D ) = "white" {}
		Material_Texture2D_21( "TopTint_layer_Basecolor", 2D ) = "white" {}
		Material_Texture2D_22( "main_layer_Metallic", 2D ) = "white" {}
		...
		Normal_intensity_main_layer( "Normal_intensity_main_layer", Float ) = 5.000000
		...
		Normal_intensity_R_channel( "Normal_intensity_R_channel", Float ) = 5.000000
		...
		R_channel_extend( "R_channel_extend", Float ) = -0.472000
		UVmask_R_opacity_bloor( "UVmask_R_opacity_bloor", Float ) = 1.000000
		UVmask_R_opacity( "UVmask_R_opacity", Float ) = 1.000000
		Grunge_tiling_R_channel( "Grunge_tiling_R_channel", Float ) = 1.000000
		Grunge_channel_R_power( "Grunge_channel_R_power", Float ) = 1.000000
		...
		UV_Tiling_G_channel( "UV_Tiling_G_channel", Float ) = 10.000000
		...
		G_channel_contrast( "G_channel_contrast", Float ) = 1.601330
		...
		G_channel_blend( "G_channel_blend", Float ) = 10.000000
		...
		Grunge_tiling_G_channel( "Grunge_tiling_G_channel", Float ) = 100.000000
		Grunge_channel_G_power( "Grunge_channel_G_power", Float ) = 10.000000
		...
		UV_Tiling_B_channel( "UV_Tiling_B_channel", Float ) = 10.000000
		...
		B_channel_contrast( "B_channel_contrast", Float ) = 2.000000
		...
		B_channel_blend( "B_channel_blend", Float ) = 8.829271
		B_channel_extend( "B_channel_extend", Float ) = 0.472540
		UVmask_B_opacity_bloor( "UVmask_B_opacity_bloor", Float ) = 1.000000
		UVmask_B_opacity( "UVmask_B_opacity", Float ) = 1.000000
		Grunge_tiling_B_channel( "Grunge_tiling_B_channel", Float ) = 10.000000
		Grunge_channel_B_power( "Grunge_channel_B_power", Float ) = 1.000000
		...
		Rotation_custom_TopTint_layer( "Rotation_custom_TopTint_layer", Float ) = 0.000000
		U_tile_TopTint_layer( "U_tile_TopTint_layer", Float ) = 0.000000
		V_tile_TopTint_layer( "V_tile_TopTint_layer", Float ) = 0.000000
		UV_Tiling_TopTint_layer( "UV_Tiling_TopTint_layer", Float ) = 10.000000
		Base_UV___U_Tiling_TopTint_layer( "Base_UV___U_Tiling_TopTint_layer", Float ) = 1.000000
		Base_UV___V_Tiling_TopTint_layer( "Base_UV___V_Tiling_TopTint_layer", Float ) = 1.000000
		Normal_intensity_TopTint_layer( "Normal_intensity_TopTint_layer", Float ) = 1.000000
		TopTint_layer_contrast( "TopTint_layer_contrast", Float ) = 1.000000
		Disp_Contrast_TopTint_layer( "Disp_Contrast_TopTint_layer", Float ) = 0.000000
		Disp_Intensity_TopTint_layer( "Disp_Intensity_TopTint_layer", Float ) = 1.000000
		TopTint_layer_blend( "TopTint_layer_blend", Float ) = 1.000000
		TopTint_layer_extend( "TopTint_layer_extend", Float ) = 0.300000
		BlendSharp_2( "BlendSharp_2", Float ) = 3.000000
		BlendSharp_1( "BlendSharp_1", Float ) = 4.000000
		Tiling_noise( "Tiling_noise", Float ) = 1.000000
		noise_power( "noise_power", Float ) = 1.000000
		color_tone_main_layer( "color_tone_main_layer", Float ) = 0.000000
		Brightness_main_layer( "Brightness_main_layer", Float ) = 0.400000
		...
		Brightness_R_channel( "Brightness_R_channel", Float ) = 0.200000
		...
		color_tone_G_channel( "color_tone_G_channel", Float ) = -0.982003
		Brightness_G_channel( "Brightness_G_channel", Float ) = 0.828927
		...
		color_tone_B_channel( "color_tone_B_channel", Float ) = 0.080000
		Brightness_B_channel( "Brightness_B_channel", Float ) = 0.632000
		contrast_B_channel( "contrast_B_channel", Float ) = 0.000000
		...
		Brightness_B_all_mask( "Brightness_B_all_mask", Float ) = 0.700000
		contrast_B_all_mask( "contrast_B_all_mask", Float ) = 0.000000
		Tint_base_color_B_all_mask( "Tint_base_color_B_all_mask", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		color_tone_TopTint_layer( "color_tone_TopTint_layer", Float ) = 0.000000
		Brightness_TopTint_layer( "Brightness_TopTint_layer", Float ) = 1.000000
		contrast_TopTint_layer( "contrast_TopTint_layer", Float ) = 0.000000
		Tint_base_color_TopTint_layer( "Tint_base_color_TopTint_layer", Color ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		...
		Metallic_TopTint_layer( "Metallic_TopTint_layer", Float ) = 0.000000
		...
		Specular_TopTint_layer( "Specular_TopTint_layer", Float ) = 0.150000
		...
		Roughness_min_TopTint_layer( "Roughness_min_TopTint_layer", Float ) = 0.000000
		Roughness_max_TopTint_layer( "Roughness_max_TopTint_layer", Float ) = 1.000000
		...
		AO_Contrast_TopTint_layer( "AO_Contrast_TopTint_layer", Float ) = 1.000000
		AO_Intensity_TopTint_layer( "AO_Intensity_TopTint_layer", Float ) = 1.000000
    ...
    SubShader
    {
        ...
        #include "MI_church_metal_1.hlsl"
